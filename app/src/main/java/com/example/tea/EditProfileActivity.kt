...
class EditProfileActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        if(editUser.gender == "Male"){
            maleBtn.setBackgroundTintList(ColorStateList.valueOf(resources.getColor(R.color.crimson)));
            ...
            femaleBtn.setBackgroundTintList(ColorStateList.valueOf(resources.getColor(R.color.crimson)));
        }
