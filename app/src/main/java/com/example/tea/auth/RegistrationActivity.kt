...
class RegistrationActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        maleButton.setOnClickListener {
            ...
            female.setBackgroundTintList(ColorStateList.valueOf(resources.getColor(R.color.white)));
        }

        female.setOnClickListener {
            user.gender = "Female"
            maleButton.setBackgroundTintList(ColorStateList.valueOf(resources.getColor(R.color.white)));
            female.setBackgroundTintList(ColorStateList.valueOf(resources.getColor(R.color.crimson)));
        }
